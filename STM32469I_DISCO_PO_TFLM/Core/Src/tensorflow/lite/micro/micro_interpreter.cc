...
//	uart_buf_len = sprintf((char *)debugPrintPtr, "1 \n");
...
//	uart_buf_len = sprintf((char *)debugPrintPtr, "2 \n");
//	HAL_UART_Transmit(&huart3, (uint8_t *)(char *)debugPrintPtr, uart_buf_len, 100);
//  debugPrintPtr += 32;
...
//  debugPrintPtr += 32;
  ...
  for (size_t i = 0; i < outputs_size(); ++i) {
	...
	#ifdef OVERLAY_FW
	oc_input_tensors[0].data.data	= (void *)&oc_input_tensors_buffers[0][0];
	oc_input_tensors[1].data.data	= (void *)&oc_input_tensors_buffers[1][0];
	...
	oc_input2_tensors[0].data.data	= (void *)&oc_input2_tensors_buffers_0[0];
	oc_input2_tensors[1].data.data	= (void *)&oc_input2_tensors_buffers_1[1];
	...
	#ifdef OVERLAY_BIASES
	oc_input3_tensor.data.data		= (void *)&oc_input3_tensor_buffer[0];
...
//	uart_buf_len = sprintf((char *)debugPrintPtr, "debug_dump_dma_waiting_conv: %X us \r\n", debug_dump_dma_waiting_conv);
////	HAL_UART_Transmit(&huart3, (uint8_t *)(char *)debugPrintPtr, uart_buf_len, 100);
//    debugPrintPtr += 32;
//	uart_buf_len = sprintf((char *)debugPrintPtr, "debug_dump_dma_waiting_convp0: %X us \r\n", debug_dump_dma_waiting_convp0);
////	HAL_UART_Transmit(&huart3, (uint8_t *)(char *)debugPrintPtr, uart_buf_len, 100);
//    debugPrintPtr += 32;
...
//		uart_buf_len = sprintf((char *)debugPrintPtr, "parting op: %u us \r\n", i);
//		HAL_UART_Transmit(&huart3, (uint8_t *)(char *)debugPrintPtr, uart_buf_len, 100);
//	    debugPrintPtr += 32;
...
//			PartitionPoolOp( &context_, node, registration, &partitioned_exec_state.ops_parts_info[i], PARTITION_FACTOR );
	...
	PartitionOp( &context_, node_and_registrations_, &partitioned_exec_state );
...
//	uart_buf_len = sprintf((char *)debugPrintPtr, "operator->size %u \r\n", subgraph_->operators()->size());
//	HAL_UART_Transmit(&huart3, (uint8_t *)(char *)debugPrintPtr, uart_buf_len, 100);
//    debugPrintPtr += 32;
...
//		uart_buf_len = sprintf((char *)debugPrintPtr, "%u/10ms \r\n", timer_val);
//		HAL_UART_Transmit(&huart3, (uint8_t *)(char *)debugPrintPtr, uart_buf_len, 100);
//    debugPrintPtr += 32;
//    }
