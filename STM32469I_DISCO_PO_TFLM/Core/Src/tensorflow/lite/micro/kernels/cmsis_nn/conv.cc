...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
  ...
  #ifdef OVERLAY_FW
//  char debugPrintPtr[100];
  int uart_buf_len;

//  uart_buf_len = sprintf((char *)debugPrintPtr, "Conv Scratch Buffer size %i\n", buf_size);
//  HAL_UART_Transmit(&huart3, (uint8_t *)(char *)debugPrintPtr, uart_buf_len, 100);
//  debugPrintPtr += 32;
  if (buf_size > INPUT2_TENSOR_BUFFER_1_SIZE) {

	  uart_buf_len = sprintf((char *)debugPrintPtr, "Conv Scratch Buffer too small for buffer size %u\n", buf_size);
//	  HAL_UART_Transmit(&huart3, (uint8_t *)(char *)debugPrintPtr, uart_buf_len, 100);
	  debugPrintPtr += 32;
//	  return kTfLiteError;
  }
...
//			debugPrintPtr += 32;
	...
	if ( (num_channels * sizeof(int32_t)) < QUANT_PARAMS_BUFFER_SIZE ) {
...
//	  uart_buf_len = sprintf((char *)debugPrintPtr, "part: %u\n", p);
//	  HAL_UART_Transmit(&huart3, (uint8_t *)(char *)debugPrintPtr, uart_buf_len, 100);
//	  debugPrintPtr += 32;
...
//		uart_buf_len = sprintf((char *)debugPrintPtr, "Copying Next Filter");
//		debugPrintPtr += 32;
	}
	#endif
...
//		uart_buf_len = sprintf((char *)debugPrintPtr, "Copying Next Bias");
//		debugPrintPtr += 32;
	}
	#endif
