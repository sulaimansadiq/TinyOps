...
CC_SRCS += \
../Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w0_5-r224.cc \
../Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w0_75-r224.cc \
../Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w1_0-r192.cc \
../Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w1_3-r224.cc 

CC_DEPS += \
./Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w0_5-r224.d \
./Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w0_75-r224.d \
./Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w1_0-r192.d \
./Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w1_3-r224.d 

OBJS += \
./Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w0_5-r224.o \
./Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w0_75-r224.o \
./Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w1_0-r192.o \
./Core/Src/tensorflow/lite/micro/examples/hello_world/test/mnasnet-w1_3-r224.o 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/tensorflow/lite/micro/examples/hello_world/test/%.o: ../Core/Src/tensorflow/lite/micro/examples/hello_world/test/%.cc Core/Src/tensorflow/lite/micro/examples/hello_world/test/subdir.mk
