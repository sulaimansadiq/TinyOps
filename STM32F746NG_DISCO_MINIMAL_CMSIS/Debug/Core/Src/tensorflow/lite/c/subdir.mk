...
C_SRCS += \
../Core/Src/tensorflow/lite/c/common.c 

OBJS += \
./Core/Src/tensorflow/lite/c/common.o 

C_DEPS += \
./Core/Src/tensorflow/lite/c/common.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/tensorflow/lite/c/%.o: ../Core/Src/tensorflow/lite/c/%.c Core/Src/tensorflow/lite/c/subdir.mk
...
clean: clean-Core-2f-Src-2f-tensorflow-2f-lite-2f-c

clean-Core-2f-Src-2f-tensorflow-2f-lite-2f-c:
	-$(RM) ./Core/Src/tensorflow/lite/c/common.d ./Core/Src/tensorflow/lite/c/common.o

.PHONY: clean-Core-2f-Src-2f-tensorflow-2f-lite-2f-c
