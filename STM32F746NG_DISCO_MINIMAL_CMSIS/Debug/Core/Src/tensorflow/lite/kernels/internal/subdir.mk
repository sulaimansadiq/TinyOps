...
CC_SRCS += \
../Core/Src/tensorflow/lite/kernels/internal/quantization_util.cc 

CC_DEPS += \
./Core/Src/tensorflow/lite/kernels/internal/quantization_util.d 

OBJS += \
./Core/Src/tensorflow/lite/kernels/internal/quantization_util.o 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/tensorflow/lite/kernels/internal/%.o: ../Core/Src/tensorflow/lite/kernels/internal/%.cc Core/Src/tensorflow/lite/kernels/internal/subdir.mk
...
clean: clean-Core-2f-Src-2f-tensorflow-2f-lite-2f-kernels-2f-internal

clean-Core-2f-Src-2f-tensorflow-2f-lite-2f-kernels-2f-internal:
	-$(RM) ./Core/Src/tensorflow/lite/kernels/internal/quantization_util.d ./Core/Src/tensorflow/lite/kernels/internal/quantization_util.o

.PHONY: clean-Core-2f-Src-2f-tensorflow-2f-lite-2f-kernels-2f-internal
