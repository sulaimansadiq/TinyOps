...
CC_DEPS += \
./Core/Src/tensorflow/lite/kernels/kernel_util.d 
...
Core/Src/tensorflow/lite/kernels/%.o: ../Core/Src/tensorflow/lite/kernels/%.cc Core/Src/tensorflow/lite/kernels/subdir.mk
...
clean: clean-Core-2f-Src-2f-tensorflow-2f-lite-2f-kernels

clean-Core-2f-Src-2f-tensorflow-2f-lite-2f-kernels:
	-$(RM) ./Core/Src/tensorflow/lite/kernels/kernel_util.d ./Core/Src/tensorflow/lite/kernels/kernel_util.o

.PHONY: clean-Core-2f-Src-2f-tensorflow-2f-lite-2f-kernels
