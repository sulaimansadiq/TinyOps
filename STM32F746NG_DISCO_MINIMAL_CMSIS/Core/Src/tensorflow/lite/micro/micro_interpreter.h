...
class MicroInterpreter {
 public:
  ...
  #ifdef OVERLAY_FW
  uint8_t PartitionOp( const TfLiteContext *, NodeAndRegistration *, volatile PartitionedExecutionState * exec_state );
  uint32_t Partition_GetMaxSize( const TfLiteContext *, NodeAndRegistration *, volatile PartitionedExecutionState * exec_state );

  void PartitionConvOp( const TfLiteContext *, TfLiteNode *, const TfLiteRegistration *, volatile PartitionInfo *, uint32_t );
  void PartitionPoolOp( const TfLiteContext *, TfLiteNode *, const TfLiteRegistration *, volatile PartitionInfo *, uint32_t );
  void PartitionPadOp( const TfLiteContext *, TfLiteNode *, const TfLiteRegistration *, volatile PartitionInfo *, uint32_t );
  void PartitionAddOp( const TfLiteContext *, TfLiteNode *, const TfLiteRegistration *, volatile PartitionInfo *, uint32_t );
  void PartitionMulOp( const TfLiteContext *, TfLiteNode *, const TfLiteRegistration *, volatile PartitionInfo *, uint32_t );
  void PartitionHardSwishOp( const TfLiteContext *, TfLiteNode *, const TfLiteRegistration *, volatile PartitionInfo *, uint32_t );

  void OVERLAY_GetMaxSizes( const TfLiteContext *, NodeAndRegistration *, volatile PartitionedExecutionState * exec_state );
  #endif
