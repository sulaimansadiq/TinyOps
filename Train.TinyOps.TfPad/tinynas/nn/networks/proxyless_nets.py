...
class ProxylessNASNets(MyNetwork):
    ...
    def __init__(self, first_conv, blocks, feature_mix_layer, final_conv, classifier):
    ...
    def module_str(self):
        ...
        _str += self.final_conv.module_str + '\n'
    ...
    def config(self):
        return {
            ...
            'final_conv': None if self.final_conv is None else self.final_conv.config,
    ...
    def build_from_config(config):
        ...
        final_conv = set_layer_from_config(config['final_conv'])
        ...
        net = ProxylessNASNets(first_conv, blocks, feature_mix_layer, final_conv, classifier)
        if 'bn' in config:
